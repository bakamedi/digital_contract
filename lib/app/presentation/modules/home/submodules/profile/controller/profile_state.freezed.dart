...
class _$ProfileStateImpl extends _ProfileState {
  const _$ProfileStateImpl({this.signatureFile}) : super._();
  ...
  @override
  String toString() {
    return 'ProfileState(signatureFile: $signatureFile)';
  }
...
abstract class _ProfileState extends ProfileState {
  const factory _ProfileState({final File? signatureFile}) = _$ProfileStateImpl;
